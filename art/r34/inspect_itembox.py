...
SRC = pathlib.Path(r'C:/Users/User/Documents/Playground/mushroom-rally/assets/itembox.glb')
...
pathlib.Path(r'C:/Users/User/Documents/Playground/mushroom-rally/art/r34/itembox_inspect.json').write_text(
    json.dumps(report, indent=1), encoding='utf-8')
print('ITEMBOX ' + json.dumps(report))
