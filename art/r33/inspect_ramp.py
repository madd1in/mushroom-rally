...
SRC = pathlib.Path(r'C:/Users/User/Documents/Playground/mushroom-rally/assets/ramp.glb')
...
pathlib.Path(r'C:/Users/User/Documents/Playground/mushroom-rally/art/r33/ramp_inspect.json').write_text(
    json.dumps(report, indent=1), encoding='utf-8')
print('RAMP ' + json.dumps(report))
