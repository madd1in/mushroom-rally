...
SRC = pathlib.Path(r'C:/Users/User/Documents/Playground/mushroom-rally/assets/driver.glb')
...
pathlib.Path(r'C:/Users/User/Documents/Playground/mushroom-rally/art/r29/driver_inspect.json').write_text(
    json.dumps(report, indent=1), encoding='utf-8')
print('DRIVER ' + json.dumps(report))
